...
const QnA_Detail = () => {
  const { qna, writeButton, onChange } = useQnAContext();
  return (
    <div>
      ...
      <div className="border-2 pt-5 flex-col  ">
        <div className="flex space-x-2 pb-3 justify-center ">
          ...
          <input onChange={onChange} name="qna_title" className="flex-1 bg-slate-200" value={qna.title} />
        </div>
        <div className="flex items-center space-x-2 pb-3">
          <label className="flex-1 text-center">ID</label>
          <input onChange={onChange} name="qna_id" className="flex-1 bg-slate-200" value={qna.id} />
        </div>
        <div className="flex items-center space-x-2 pb-3">
          <label className="flex-1 text-center">E-mail</label>
          <input onChange={onChange} name="qna_email" className="flex-1 bg-slate-200" value={qna.email} />
        </div>
        <div className="flex items-center space-x-2 pb-3">
          <label className="flex-1 text-center">시설 이름</label>
          <input onChange={onChange} name="qna_name" className="flex-1 bg-slate-200" value={qna.name} />
        </div>
        <div className="flex items-center space-x-2 pb-3">
          <label className="flex-1 text-center">문의 내용</label>
          <input onChange={onChange} name="qna_text" className="flex-1 bg-slate-200" value={qna.text} />
        </div>
      </div>
      <div className="pt-2 pr-3 pl-3 pb-2  m-3 flex justify-end">
        ...
        <button className="mr-10 hover:bg-slate-200 pt-2 pr-3 pl-3 pb-2">삭제</button>
